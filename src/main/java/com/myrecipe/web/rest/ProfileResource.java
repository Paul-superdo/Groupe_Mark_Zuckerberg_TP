...
/**
 * REST controller for managing {@link com.myrecipe.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProfileResource {
    ...
    public ResponseEntity<Profile> partialUpdateProfile(
        ...
        Optional<Profile> result = profileRepository
            ...
            .map(existingProfile -> {
                if (profile.getProfilImageUrl() != null) {
                    existingProfile.setProfilImageUrl(profile.getProfilImageUrl());
                }
                if (profile.getImageDescription() != null) {
                    existingProfile.setImageDescription(profile.getImageDescription());
                }
