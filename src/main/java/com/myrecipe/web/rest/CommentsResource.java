...
/**
 * REST controller for managing {@link com.myrecipe.domain.Comments}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Comments> partialUpdateComments(
        ...
        Optional<Comments> result = commentsRepository
            ...
            .map(existingComments -> {
                if (comments.getContenteText() != null) {
                    existingComments.setContenteText(comments.getContenteText());
                }
