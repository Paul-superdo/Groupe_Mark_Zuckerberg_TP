...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rule.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RULE actions', async () => {
      const expectedActions = [
        {
