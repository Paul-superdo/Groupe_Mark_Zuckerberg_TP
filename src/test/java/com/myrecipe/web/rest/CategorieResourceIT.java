...
import com.myrecipe.domain.Categorie;
import com.myrecipe.repository.CategorieRepository;
...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).creationDate(DEFAULT_CREATION_DATE);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).creationDate(UPDATED_CREATION_DATE);
        return categorie;
    }
    ...
    void putExistingCategorie() throws Exception {
        ...
        updatedCategorie.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).creationDate(UPDATED_CREATION_DATE);
    ...
    void fullUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).creationDate(UPDATED_CREATION_DATE);
